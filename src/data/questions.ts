...
export const QUESTION_BANK: Question[] = [
  ...
  // ==========================================
  // --- 点繋ぎ問題 (Dot Connect Matching) ---
  // ==========================================
  {
    id: 'match_01',
    type: 'matching',
    difficulty: '5kyu',
    japanese: '気持ち・感情の英単語と絵文字を線で繋ごう！',
    english: 'happy, sad, good, angry',
    correctAnswer: 'all',
    explanation: 'happy=うれしい(☺️)、sad=かなしい(😢)、good=いいね(👍)、angry=おこった(😡)',
    matchingPairs: [
      { id: 'm1_happy', left: 'happy', right: '☺️ うれしい' },
      { id: 'm1_sad', left: 'sad', right: '😢 かなしい' },
      { id: 'm1_good', left: 'good', right: '👍 いいね' },
      { id: 'm1_angry', left: 'angry', right: '😡 おこった' },
    ],
  },
  {
    id: 'match_02',
    ...
    correctAnswer: 'all',
    explanation: 'sunny=晴れ(☀️)、rainy=雨(🌧️)、cloudy=くもり(☁️)、snowy=雪(❄️)',
    matchingPairs: [
      { id: 'm2_sunny', left: 'sunny', right: '☀️ はれ' },
      { id: 'm2_rainy', left: 'rainy', right: '🌧️ あめ' },
      { id: 'm2_cloudy', left: 'cloudy', right: '☁️ くもり' },
      { id: 'm2_snowy', left: 'snowy', right: '❄️ ゆき' },
    ],
  },
  {
    id: 'match_03',
    type: 'matching',
    difficulty: '5kyu',
    japanese: '動物の英単語とアイコンを線で繋ごう！',
    english: 'dog, cat, bird, fish',
    correctAnswer: 'all',
    explanation: 'dog=いぬ(🐶)、cat=ねこ(🐱)、bird=とり(🐦)、fish=さかな(🐟)',
    matchingPairs: [
      { id: 'm3_dog', left: 'dog', right: '🐶 いぬ' },
      { id: 'm3_cat', left: 'cat', right: '🐱 ねこ' },
      { id: 'm3_bird', left: 'bird', right: '🐦 とり' },
      { id: 'm3_fish', left: 'fish', right: '🐟 さかな' },
    ],
  },
  {
    id: 'match_04',
    type: 'matching',
    difficulty: '5kyu',
    japanese: 'ステーショナリーグッズとアイコンを線で繋ごう！',
    english: 'pencil, marker, eraser, ruler',
    correctAnswer: 'all',
    explanation: 'pencil=えんぴつ(✏️)、marker=マーカー(🖊️)、eraser=消しゴム(🧽)、ruler=ものさし(📏)',
    matchingPairs: [
      { id: 'm4_pencil', left: 'pencil', right: '✏️ えんぴつ' },
      { id: 'm4_marker', left: 'marker', right: '🖊️ マーカー' },
      { id: 'm4_eraser', left: 'eraser', right: '🧽 消しゴム' },
      { id: 'm4_ruler', left: 'ruler', right: '📏 ものさし' },
    ],
  },
  {
    id: 'match_05',
    type: 'matching',
    difficulty: '5kyu',
    japanese: '色の名前とイメージを線で繋ごう！',
    english: 'red, blue, green, yellow',
    correctAnswer: 'all',
    explanation: 'red=赤(🍎)、blue=青(🌊)、green=緑(🌿)、yellow=黄色(🌻)',
    matchingPairs: [
      { id: 'm5_red', left: 'red', right: '🍎 あか' },
      { id: 'm5_blue', left: 'blue', right: '🌊 あお' },
      { id: 'm5_green', left: 'green', right: '🌿 みどり' },
      { id: 'm5_yellow', left: 'yellow', right: '🌻 きいろ' },
    ],
  },
  {
    id: 'match_06',
    type: 'matching',
    difficulty: '5kyu',
    japanese: '日常のあいさつと意味を線で繋ごう！',
    english: 'Good morning, Hello, Thank you, Good night',
    correctAnswer: 'all',
    explanation: 'Good morning=おはよう(🌅)、Hello=こんにちは(👋)、Thank you=ありがとう(🎁)、Good night=おやすみ(🌙)',
    matchingPairs: [
      { id: 'm6_gm', left: 'Good morning', right: '🌅 おはよう' },
      { id: 'm6_hello', left: 'Hello', right: '👋 こんにちは' },
      { id: 'm6_ty', left: 'Thank you', right: '🎁 ありがとう' },
      { id: 'm6_gn', left: 'Good night', right: '🌙 おやすみ' },
    ],
  },
  {
    id: 'match_07',
    type: 'matching',
    difficulty: '5kyu',
    japanese: 'たべもの・のみものとアイコンを線で繋ごう！',
    english: 'apple, milk, water, bread',
    correctAnswer: 'all',
    explanation: 'apple=りんご(🍎)、milk=ぎゅうにゅう(🥛)、water=みず(💧)、bread=パン(🍞)',
    matchingPairs: [
      { id: 'm7_apple', left: 'apple', right: '🍎 りんご' },
      { id: 'm7_milk', left: 'milk', right: '🥛 ぎゅうにゅう' },
      { id: 'm7_water', left: 'water', right: '💧 おみず' },
      { id: 'm7_bread', left: 'bread', right: '🍞 パン' },
    ],
  },
  {
    id: 'match_08',
    type: 'matching',
    difficulty: '5kyu',
    japanese: '動作の英単語とアイコンを線で繋ごう！',
    english: 'run, eat, sleep, read',
    correctAnswer: 'all',
    explanation: 'run=はしる(🏃)、eat=たべる(🍽️)、sleep=ねる(💤)、read=よむ(📖)',
    matchingPairs: [
      { id: 'm8_run', left: 'run', right: '🏃 はしる' },
      { id: 'm8_eat', left: 'eat', right: '🍽️ たべる' },
      { id: 'm8_sleep', left: 'sleep', right: '💤 ねる' },
      { id: 'm8_read', left: 'read', right: '📖 よむ' },
    ],
  },
  {
    id: 'match_09',
    type: 'matching',
    difficulty: '4kyu',
    japanese: '家族の呼び方とアイコンを線で繋ごう！',
    english: 'mother, father, brother, sister',
    correctAnswer: 'all',
    explanation: 'mother=お母さん(👩)、father=お父さん(👨)、brother=兄・弟(👦)、sister=姉・妹(👧)',
    matchingPairs: [
      { id: 'm9_mother', left: 'mother', right: '👩 お母さん' },
      { id: 'm9_father', left: 'father', right: '👨 お父さん' },
      { id: 'm9_brother', left: 'brother', right: '👦 兄弟(兄・弟)' },
      { id: 'm9_sister', left: 'sister', right: '👧 姉妹(姉・妹)' },
    ],
  },
  {
    id: 'match_10',
    type: 'matching',
    difficulty: '4kyu',
    japanese: '反対の意味の単語を線で繋ごう！',
    english: 'big - small, hot - cold',
    correctAnswer: 'all',
    explanation: 'big(大きい)↔️small(小さい)、hot(あつい)↔️cold(つめたい)',
    matchingPairs: [
      { id: 'm10_big', left: 'big (おおきい)', right: 'small (ちいさい) 🐭' },
      { id: 'm10_small', left: 'hot (あつい)', right: 'cold (つめたい) ❄️' },
      { id: 'm10_fast', left: 'fast (はやい)', right: 'slow (おそい) 🐢' },
